 ...
 *
 * SECONDARY screen. `/dashboard` is now the Action Center ("what needs my
 * attention today?"); this page is the cross-module metrics roll-up, for when
 * you want totals rather than a work queue.
 *

...
const ROLE_PERMISSIONS: Record<OrgRole, string[]> = {
  ...
  member:  ["org.read", "plans.view", "usage.view", "developer.view", "data.write", "domain_event.read", "entity_link.read", "entity_link.create", "automation.read", "action_center.view", "action_center.resolve", "action_center.dismiss", "action_center.execute"],
};

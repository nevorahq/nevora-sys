...
export default function SubscriptionsServicePage() {
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "80px 24px" }}>
      ...
      <h1 style={{ fontSize: 44, margin: "12px 0" }}>Subscriptions runtime</h1>
      <p style={{ color: "#b7c0d8", fontSize: 18, lineHeight: 1.6 }}>
        This independently built service verifies operation-bound identities
        and executes Subscriptions reads and mutations against Supabase
        locally, provisioning payment tasks through the Tasks service.
      </p>
      <dl style={{ display: "grid", gridTemplateColumns: "10rem 1fr", gap: 12, marginTop: 36 }}>
        <dt style={{ color: "#8ea0c9" }}>Stage</dt>
        <dd style={{ margin: 0 }}>{SUBSCRIPTIONS_EXTRACTION_STAGE}</dd>

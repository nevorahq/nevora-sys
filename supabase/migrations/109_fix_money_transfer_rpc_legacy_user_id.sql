-- Fix create_money_transfer runtime error 42703 on the organization-scoped
-- money_transactions schema. The legacy user_id column is absent in beta;
-- actor attribution is stored in created_by / updated_by like all current
-- money transaction write paths.
